...
checkpoint = ModelCheckpoint(filepath=f'models/vae/tmp/{model_name}/checkpoint', monitor='val_mse', verbose=0, save_best_only=True, mode='min', save_weights_only=True)    
print(f'Training {model_name}')


latent_dim = sig_len//4
encoder_net = get_encoder_model(latent_dim, (window_len, 2), 32, first_kernel_size=15)
