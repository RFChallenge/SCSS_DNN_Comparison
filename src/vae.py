...
# ==================== Encoder/Decoder ==================== #
def get_encoder_model(latent_dim, input_shape, n_encode_filters=64, first_kernel_size=101):
...
def get_decoder_model(latent_dim, output_shape, n_decode_filters=64):
    ...
    x = layers.Dense(n_window*n_decode_filters, activation='relu')(x)
    x = layers.Reshape((n_window, n_decode_filters))(x)
